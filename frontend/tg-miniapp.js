  ...
  function renderLearn() {
    ...
    const promptLead = () => {
      const leads = {
        ...
        openai_any: "В своём клиенте отправь задачу на Zeus:",
    ...
    const steps = [
      () => `
        ...
        <div class="body">
          <ul>
            <li>Один ключ · в клиенте модель всегда <b>zeuscode</b></li>
      ...
      () => `
        <h1>Три режима</h1>
        <p class="lead">Это не отдельные модели в Cursor/OpenCode. Везде один id <b>zeuscode</b> — режим меняешь здесь.</p>
        <div class="body">
          <ul>

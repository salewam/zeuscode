...
(() => {
  ...
  function renderLearn() {
    ...
    const steps = [
      () => `
        <h1>Привет, это Zeus Code</h1>
        <p class="lead">Наша платформа умеет встраивать в один ключ до трех нейросетей одновременно.</p>
        <p class="lead">Следуй по инструкции и удачного кодинга!</p>`,
      () => `

# Промпт: автосервис + малярка (МоторХаус)

Используется в bakeoff 3 режимов Fusion.

```
Сделай продающий одностраничный сайт автосервиса «МоторХаус» на Каширском шоссе.
